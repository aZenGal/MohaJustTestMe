...
def nmap_scan():
    def tcp_scan():
        ...
        tcp_host = input(
            conf.colored(
                "\nSaisissez l'IP dont vous voulez analyser les ports: ",
                "green",
                attrs=["bold"],
            ))
        tcp_output = input(
            conf.colored(
                f"Saisir le dossier de sortie - [defaut: reports/Nmap/{tcp_host}/]: ",
                "green",
                attrs=["bold"],
            ))
    ...
    def udp_scan():
        ...
        udp_host = input(
            conf.colored(
                "\nSaisissez l'IP dont vous voulez scanner les ports: ",
                "green",
                attrs=["bold"],
            ))
        udp_output = input(
            conf.colored(
                f"Saisir le dossier de sortie - [defaut: reports/Nmap/{udp_host}/]: ",
                "green",
                attrs=["bold"],
            ))
    ...
    def os_scan():
        ...
        os_host = input(
            conf.colored(
                "\nEntrez l'IP dont vous voulez trouver le système d'exploitation: ",
                "green",
                attrs=["bold"],
            ))
        os_output = input(
            conf.colored(
                f"Saisir le dossier de sortie - [defaut: reports/Nmap/{os_host}/]: ",
                "green",
                attrs=["bold"],
            ))
    ...
    def a_scan():
        ...
        a_host = input(
            conf.colored("\nEntrez l'IP que vous voulez scanner: ",
                         "green",
                         attrs=["bold"]))
        a_output = input(
            conf.colored(
                f"Saisir le dossier de sortie - [defaut: reports/Nmap/{a_host}/]: ",
                "green",
                attrs=["bold"],
            ))
    ...
    def net_scan():
        ...
        net_host = input(
            conf.colored(
                "\nSaisissez votre adresse et votre plage (ex: 192.168.0.1/24): ",
                "green",
                attrs=["bold"],
            ))
        ...
        sn_output = input(
            conf.colored(
                f"Saisir le dossier de sortie - [default: reports/Nmap/{net_sort}/]: ",
                "green",
                attrs=["bold"],
            ))
    ...
    print("================================================")
    print(
        conf.colored("\n1. Scan de ports ouverts d'une adresse IP avec TCP",
                     "yellow",
                     attrs=["bold"]))
    print(
        conf.colored("2. Scan de ports ouverts d'une adresse IP avec UDP",
                     "yellow",
                     attrs=["bold"]))
    print(conf.colored("3. Scan du système d'exploitation", "yellow", attrs=["bold"]))
    print(
        conf.colored("4. Scan agressif d'une adresse IP",
                     "yellow",
                     attrs=["bold"]))
    print(
        conf.colored("5. Scanner le réseau pour tous les appareils",
                     "yellow",
                     attrs=["bold"]))
